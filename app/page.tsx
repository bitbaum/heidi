  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-shell flex-col px-5 sm:px-8">
      <header className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2 border-b border-border-subtle py-5">
        <span className="whitespace-nowrap font-heading text-2xl font-semibold tracking-display text-fg-primary">{c.brand}</span>
        <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
          ...
          <span className="whitespace-nowrap font-mono text-[11px] uppercase tracking-caps text-fg-muted">{c.eyebrow}</span>
        </div>
      </header>
