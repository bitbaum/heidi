 ...
 * a little bit false.
 */
export function MatchView({ item, t, grammarT, locale, onAnswer }: ExerciseViewProps) {
  ...
  return (
    <div className="mt-5">
      ...
      */}
      ...
      {done && (
        <Verdict right={!missed} t={t} grammarT={grammarT} item={item} locale={locale} onNext={() => onAnswer(missed ? "wrong" : "right")} />
      )}
    </div>
  );
}
