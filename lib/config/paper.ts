  ...
  sections: [
    {
      ...
      body: [
        ...
        "Around that sit the things a learner needs next: a grammar section of nineteen topics, two hundred and twenty-six words chosen because they block sentences rather than because they are common, nineteen scenes of what is actually said — at the Gemeinde, in the laundry room, at the doctor's and during a working shift — and 1,451 practice questions generated from that same checked material.",
  ...
  sections: [
    {
      ...
      body: [
        ...
        "Darum herum steht, was eine Lernende als Nächstes braucht: neunzehn Grammatikthemen, zweihundertsechsundzwanzig Wörter — ausgewählt, weil sie Sätze blockieren, nicht weil sie häufig sind —, neunzehn Szenen aus dem Alltag und aus einer echten Schicht und 1451 Übungsfragen, erzeugt aus genau diesem geprüften Material.",
