...
export const LISTENING_SOURCES: readonly ListeningSource[] = [
  ...
  },
  {
    ...
    publisher: "SRF",
    medium: "series",
    url: "https://de.wikipedia.org/wiki/Seitentriebe",
    linkKind: "about",
    spoken: "dialect",
    basis: "format",
    topics: ["comedy", "drama", "everyday"],
    voices: "few",
    scripted: true,
    subtitles: "standard",
    reach: "open",
    checked: CHECKED,
    note: "Couples talking over each other — the half-sentences broadcast speech irons out.",
  },
  {
    id: "die-goettliche-ordnung",
    name: "Die göttliche Ordnung",
    publisher: "Zodiac Pictures",
    medium: "film",
    url: "https://de.wikipedia.org/wiki/Die_g%C3%B6ttliche_Ordnung",
    linkKind: "about",
    spoken: "dialect",
    basis: "format",
    // Set in the Appenzellerland and filmed across Trogen, Rehetobel, Gais,
    // Herisau and Heiden — all inside the atlas's Ostschweiz area.
    area: "ostschwiizertuetsch",
    topics: ["drama", "politics"],
    voices: "few",
    scripted: true,
    subtitles: "standard",
    reach: "open",
    checked: CHECKED,
    note: "1971, women campaigning for the federal vote. Eastern Swiss dialect, and a piece of history a learner will be asked about.",
  },
  {
    id: "zwingli",
    name: "Zwingli",
    publisher: "C-Films",
    medium: "film",
    url: "https://de.wikipedia.org/wiki/Zwingli_(Film)",
    linkKind: "about",
    spoken: "dialect",
    basis: "format",
    area: "zueriduetsch",
    topics: ["drama", "culture"],
    voices: "few",
    scripted: true,
    subtitles: "standard",
    reach: "open",
    checked: CHECKED,
    note: "Zurich's own reformation, in Zurich German. One of the few features in the variety this deployment teaches.",
  },
  {
    id: "wolkenbruch",
    name: "Wolkenbruchs wunderliche Reise in die Arme einer Schickse",
    publisher: "Turnus Film",
    medium: "film",
    url: "https://de.wikipedia.org/wiki/Wolkenbruchs_wunderliche_Reise_in_die_Arme_einer_Schickse",
    linkKind: "about",
    spoken: "dialect",
    basis: "format",
    area: "zueriduetsch",
    ...
    reach: "open",
    checked: CHECKED,
    note: "Zurich German with Yiddish beside it — a second lesson about how close two languages can sit.",
  },
  {
    id: "platzspitzbaby",
    name: "Platzspitzbaby",
    publisher: "Zodiac Pictures",
    medium: "film",
    url: "https://de.wikipedia.org/wiki/Platzspitzbaby",
    linkKind: "about",
    spoken: "dialect",
    basis: "format",
    area: "zueriduetsch",
    ...
    reach: "open",
    checked: CHECKED,
    note: "Zurich German, the city's heroin years seen by a child. Hard subject, unusually clear speech.",
  },
  {
    id: "heidi-2015",
    name: "Heidi",
    publisher: "Zodiac Pictures",
    medium: "film",
    url: "https://de.wikipedia.org/wiki/Heidi_(2015)",
    linkKind: "about",
    spoken: "dialect",
    basis: "format",
    // No area: it is SET in Graubünden, which is not the same claim as the
    // cast speaking Bündnerdütsch, and we have not checked that.
    topics: ["drama", "kids"],
    voices: "few",
    scripted: true,
    subtitles: "standard",
    reach: "open",
    checked: CHECKED,
    note: "Made for children, so spoken slowly and plainly. Probably the easiest feature on this list.",
  },
];
