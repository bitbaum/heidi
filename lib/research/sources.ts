...
export const SOURCES = {
  ...
  /**
   * THE REGIONAL LITERATURE, one or more works per dialect area: the grammars
   * and dictionaries of the series «Grammatiken und Wörterbücher des
   * Schweizerdeutschen», the regional dictionaries outside it, and the
   * recent crowd-sourced atlas work. Each links a library record (DNB,
   * e-helvetica) or a DOI, checked to resolve. A dialect page lists its own.
   */
  "hotzenkoecherle-1984": {
    kind: "reference",
    authors: "Hotzenköcherle, R. (ed. Bigler & Schläpfer)",
    year: 1984,
    title: "Die Sprachlandschaften der deutschen Schweiz",
    venue: "Sauerländer, Aarau",
    url: "https://d-nb.info/840865953",
  },
  "dialektatlas-2025": {
    kind: "reference",
    authors: "Leemann, Steiner, Studerus, Oberholzer, Jeszenszky, Tomaschek & Kistler",
    year: 2025,
    title: "Dialäktatlas: 1950 bis heute",
    venue: "vdf, Zollikon. 1,000 speakers at 125 locations surveyed 2020–21, compared with the SDS",
    url: "https://d-nb.info/1326054937",
  },
  "leemann-2016-crowdsourcing": {
    authors: "Leemann, Kolly, Purves, Britain & Glaser",
    year: 2016,
    title: "Crowdsourcing language change with smartphone applications",
    venue: "PLOS ONE 11(1): e0143060",
    url: "https://doi.org/10.1371/journal.pone.0143060",
  },
  "weber-zuerich-grammatik": {
    kind: "reference",
    authors: "Weber, A.",
    year: 1987,
    title: "Zürichdeutsche Grammatik",
    venue: "Rohr, Zürich (3rd ed.; first 1948). Grammatiken und Wörterbücher des Schweizerdeutschen 1",
    url: "https://d-nb.info/870332465",
  },
  "gallmann-zuerich-woerterbuch": {
    kind: "reference",
    authors: "Gallmann, H.",
    year: 2010,
    title: "Zürichdeutsches Wörterbuch",
    venue: "NZZ Libro, Zürich (2nd ed.). Grammatiken und Wörterbücher des Schweizerdeutschen 3",
    url: "https://d-nb.info/999515640",
  },
  "fleischer-schmid-2006": {
    authors: "Fleischer, J. & Schmid, S.",
    year: 2006,
    title: "Zurich German",
    venue: "Journal of the International Phonetic Association 36(2): 243–253",
    url: "https://doi.org/10.1017/S0025100306002441",
  },
  "marti-bern-grammatik": {
    kind: "reference",
    authors: "Marti, W.",
    year: 1985,
    title: "Berndeutsch-Grammatik für die heutige Mundart zwischen Thun und Jura",
    venue: "Francke, Bern",
    url: "https://books.google.com/books/about/Berndeutsch_Grammatik_f%C3%BCr_die_heutige_M.html?id=xw7mAAAAMAAJ",
  },
  "suter-basel-grammatik": {
    kind: "reference",
    authors: "Suter, R.",
    year: 1992,
    title: "Baseldeutsch-Grammatik",
    venue: "Christoph Merian, Basel (3rd ed.). Grammatiken und Wörterbücher des Schweizerdeutschen 6",
    url: "https://d-nb.info/920552889",
  },
  "suter-basel-woerterbuch": {
    kind: "reference",
    authors: "Suter, R.",
    year: 2006,
    title: "Baseldeutsch-Wörterbuch",
    venue: "Christoph Merian, Basel (3rd ed.). Grammatiken und Wörterbücher des Schweizerdeutschen 9",
    url: "https://d-nb.info/840357818",
  },
  "bossard-zuger-mundartbuch": {
    kind: "reference",
    authors: "Bossard, H. & Dalcher, P.",
    year: 1962,
    title: "Zuger Mundartbuch",
    venue: "Grammatiken und Wörterbücher des Schweizerdeutschen 4",
    url: "https://d-nb.info/450569004",
  },
  "aschwanden-urner-woerterbuch": {
    kind: "reference",
    authors: "Aschwanden, F.",
    year: 2013,
    title: "Neues Urner Mundart-Wörterbuch",
    venue: "Altdorf",
    url: "https://d-nb.info/1045013080",
  },
  "schaffhauser-mundartwoerterbuch": {
    kind: "reference",
    authors: "Richli, A. et al.",
    year: 2003,
    title: "Schaffhauser Mundartwörterbuch",
    venue: "Meier, Schaffhausen. Grammatiken und Wörterbücher des Schweizerdeutschen 15",
    url: "https://d-nb.info/966066189",
  },
  "sonderegger-appenzeller-sprachbuch": {
    kind: "reference",
    authors: "Sonderegger, S. & Gadmer, T.",
    year: 1999,
    title: "Appenzeller Sprachbuch",
    venue: "Appenzeller Verlag",
    url: "https://d-nb.info/122993555X",
  },
  "meng-baden-woerterbuch": {
    kind: "reference",
    authors: "Meng, H.",
    year: 1986,
    title: "Mundartwörterbuch der Landschaft Baden im Aargau",
    venue: "Baden. Grammatiken und Wörterbücher des Schweizerdeutschen 10",
    url: "https://d-nb.info/206363036",
  },
  "glarner-mundartwoerterbuch": {
    kind: "reference",
    authors: "Verein Glarner Mundartwörterbuch (ed.)",
    year: 2024,
    title: "Glarner Mundartwörterbuch",
    venue: "Baeschlin, Glarus. Grammatiken und Wörterbücher des Schweizerdeutschen 17",
    url: "https://d-nb.info/1313450529",
  },
  "solothurner-mundartverein": {
    kind: "reference",
    authors: "Friedli, M.",
    year: 2024,
    title: "Eigenart der Solothurner Dialekte",
    venue: "Solothurner Mundartverein",
    url: "https://solothurner.mundartverein.ch/eigenart-der-solothurner-dialekte/",
  },
  "schmutz-haas-sensler-woerterbuch": {
    kind: "reference",
    authors: "Schmutz, C. & Haas, W.",
    year: 2000,
    title: "Senslerdeutsches Wörterbuch",
    venue: "Paulusverlag, Freiburg",
    url: "https://d-nb.info/958282781",
  },
  "davoser-woerterbuch": {
    kind: "reference",
    authors: "Schmid, M. & Issler, G.",
    year: 1982,
    title: "Davoserdeutsches Wörterbuch",
    venue: "Chur. Grammatiken und Wörterbücher des Schweizerdeutschen 7",
    url: "https://d-nb.info/830209026",
  },
  "rheinwalder-woerterbuch": {
    kind: "reference",
    authors: "Lorez-Brunold, C. & T.",
    year: 1987,
    title: "Rheinwalder Mundartwörterbuch",
    venue: "Chur. Grammatiken und Wörterbücher des Schweizerdeutschen 11",
    url: "https://d-nb.info/880374799",
  },
  "bohnenberger-walliser-mundart": {
    kind: "reference",
    authors: "Bohnenberger, K.",
    year: 1913,
    title: "Die Mundart der deutschen Walliser im Heimattal und in den Aussenorten",
    venue: "Huber, Frauenfeld (Beiträge zur schweizerdeutschen Grammatik 6)",
    url: "https://www.e-helvetica.nb.admin.ch/de/view/monografie/991017979055203976/CH-002157-5:5911755",
  },
  "wikipedia-baseldeutsch": {
    kind: "reference",
    authors: "Wikipedia contributors",
    year: 2026,
    title: "Baseldeutsch",
    venue: "German Wikipedia (secondary; used for the unshifted k of Basel city)",
    url: "https://de.wikipedia.org/wiki/Baseldeutsch",
  },
  "wikipedia-strassenbahn-basel": {
    kind: "reference",
    authors: "Wikipedia contributors",
    year: 2026,
    title: "Strassenbahn Basel",
    venue: "German Wikipedia («baseldeutsch auch s Drämmli genannt»)",
    url: "https://de.wikipedia.org/wiki/Strassenbahn_Basel",
  },
  "wikipedia-senslerdeutsch": {
    kind: "reference",
    authors: "Wikipedia contributors",
    year: 2026,
    title: "Senslerdeutsch",
    venue: "German Wikipedia (secondary; «gùgge» for schauen)",
    url: "https://de.wikipedia.org/wiki/Senslerdeutsch",
  },
  "wikipedia-ostschweizer-dialekt": {
    kind: "reference",
    authors: "Wikipedia contributors",
    year: 2026,
    title: "Ostschweizer Dialekt",
    venue: "German Wikipedia (secondary; «näbis» in Toggenburg and Appenzell)",
    url: "https://de.wikipedia.org/wiki/Ostschweizer_Dialekt",
  },
  "sds-atlas": {
    kind: "reference",
    ...
    // The digital edition, run by the Schweizerisches Idiotikon: every map,
    // with its legend and survey points. Regional forms cite it by volume/map.
