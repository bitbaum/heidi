...
export const gsw: Dictionary = {
  ...
  speaking: {
    title: "Schwätzrunde",
    lead: "Webinar und Gsprächsrunde zu Thema wo Si sälber vorschlönd. Und dezwüsched: üebed Si luut, elei, und lönd mässe was sich ehrlich mässe laat.",
    ...
    practiceLead: "Nämed Si sich uf, wie Si über s Thema redet. D Ufnaam bliibt uf Ihrem Grät.",
    record: "Ufnee",
    stop: "Fertig",
    ...
    notes: {
      ...
      pauseCount: "{n} Pause zwüsched de Schwätz-Abschnitt.",
      meanRun: "Im Schnitt händ Si {n} Sekunde am Stuck gredt.",
