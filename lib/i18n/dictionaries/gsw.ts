...
export const gsw: Dictionary = {
  ...
  nav: {
    ...
    blurbs: {
      home: "D Startsiite",
      chat: "Nachricht iifüege, erchläre lah, antworte",
      situations: "Echti Sätz us em Alltag, vo de Arbet und us de Pflege",
      grammar: "D Regle, wo mer ghört, aber nöd kännt",
      dialect: "Züri, Bärn, Basel, Wallis und die andere",
      vocabulary: "D Wörter, wo am Zmittagstisch fallet",
      speaking: "Sälber säge, mit Rückmäldig",
      practice: "Churzi Üebige mit Erchlärig",
      listen: "Podcasts, Sändige und Serie i Mundart",
      essays: "Hintergründ und Gschichte",
      paper: "Wie Heidi baut isch, im Detail",
      roadmap: "Was als Nächschts chunt",
      changelog: "Was sich zletscht gänderet hät",
      method: "Uf was s Lerne da basiert",
      technology: "Modell, Prüefig und Dateschutz",
      contribute: "Mitboue und mitrede",
      about: "Wer hinder Heidi staht",
      organisations: "Heidi für Teams, Heim und Spitäler",
    },
    closeMenu: "Menü zuemache",
    quickChat: "Mit Heidi chatte",
    quickPractice: "Jetzt üebe",
  },
  ...
  model: {
    ...
    test: "Das Modell bruuche",
    testing: "Wird prüeft …",
    connected: "Verbunde",
    connectedWith: "Verbunde mit",
    failed: "Das hät nöd klappet",
    pasteHint: "Schlüssel iifüege — Heidi prüeft en sofort und zeigt, weli Modell er chan.",
    strongest: "stärchschts",
    vendorSaid: "De Aabieter meldet:",
  ...
  pillars: [
    ...
    },
    {
      ...
      body: "Kei Pünkt, kei erfundeni Prozäntzahle. D Zahl wo mir Ihne wänd zeige isch, wie vill Si vo ere unbekannte Zürcher Stimm verstönd — vorher und nachher.",
    },
  ],
  ...
  research: {
    ...
    decisions: [
      ...
      "Gmässe statt vergoldet. Kei Pünkt, kei erfundeni Zahle.",
  ...
  privacy: {
    ...
    flows: {
      ...
      speakingTranscription: "Ufnahm zum Mitschriibe",
  ...
  vocabulary: {
    ...
    groups: {
      ...
      helvetisms: "Wörter, wo Sie scho meined z kenne",
      slang: "Umgangssprach und Derbs",
    },
    register: { casual: "umgangssprachlich", rude: "derb" },
    mistakenForLabel: "Nöd: {assumed}",
  ...
  sync: {
    ...
    deleteAll: "Alles Abglicheni lösche",
    deleted: "Glöscht. Uf em Server isch nüüt meh vo Ihrem Fortschritt.",
    failed: "Das hät nöd klappt. Probiered Sie s nomal.",
  },
  certificate: {
    title: "Nachwiis",
    get: "Nachwiis uusstelle",
    getting: "Wird prüeft …",
    view: "Nachwiis aaluege",
    syncFirst: "Mälded Sie sich aa und schalted Sie i de Iistellige «Fortschritt uf allne Grät» ii. De Nachwiis wird uf em Server us Ihrem abglichene Fortschritt uusgstellt, nöd us dem Browser.",
    notYet: "Uf em Server sind erscht {held} vo {total} Sätz sicher — de Abgliich holt grad uuf. Probiered Sie s i ere Minute nomal.",
    failed: "Das hät nöd klappt. Probiered Sie s nomal.",
    holder: "Wer dä Nachwiis hät,",
    statement: "hät i de Situation «{scene}» jede vo de {total} Sätz, wo Heidi dezue abfrööget, mehrmals richtig verstande.",
    measured: "{held} vo {total} Sätz sicher, {stuck} devo nach ere Pause nomal.",
    issued: "Uusgstellt am {date}",
    idLabel: "Nachwiis-Nr.",
    method: "So prüeft Heidi",
    scope: "En Nachwiis über s Hörverstah i einere Situation — kei Sprachdiplom.",
    nameLabel: "Name für de Uusdruck (wird nöd gspeicheret)",
    print: "Drucke",
    notFound: "Dä Nachwiis gits nöd.",
  },
  team: {
    title: "Team",
    lead: "Wähled Sie, wora Ihres Team schafft. D Mitglieder entscheided sälber, öb s Ihne zeiged, wie wiit s i dene Situatione sind — nie, weli Sätz oder was s falsch gmacht händ.",
    focusLabel: "Schwerpunkt",
    none: "Kei Team — e Lerngruppe",
    overviewEmpty: "No niemer im Team zeigt Ihne de Stand. Jedes Mitglied chan das uf de Gruppesiite iischalte.",
    private: "zeigt de Stand nöd",
    ...
    steady: "meistens",
    sure: "sicher",
    shareTitle: "Ihre Stand im Team",
    shareBody: "Zeigt {name}, wie wiit Sie i de Situatione vom Team sind — nie, weli Sätz oder was Sie falsch gmacht händ. Defür mues i de Iistellige «Fortschritt uf allne Grät» iigschaltet sii.",
    shareOn: "Mit {name} teile",
    shareOff: "Nüme teile",
    sharing: "Sie teiled Ihre Stand.",
    failed: "Das hät nöd klappt. Probiered Sie s nomal.",
  },
  streak: {
    title: "Ihri Serie",
  ...
  practice: {
    ...
    note: "Was Si sich gmerkt händ, bliibt i Ihrem Browser — usser Sie schalted i de Iistellige «Fortschritt uf allne Grät» ii. Für d Frage us em Wortschatz bruuchts kes Konto.",
    start: "Loslege",
    restart: "Nomal",
    ...
    explain: {
      show: "Erklärig",
      ruleTitle: "D Regle",
      watchTitle: "Wo s hanget",
      contextTitle: "Im Gspröch",
      wordTitle: "S Wort",
      saidInTitle: "Au gseit i",
      askTitle: "Wyter mit de Heidi",
      moreOnTopic: "Meh zu dem Thema",
      practiseTopic: "Gnau das üebe",
    ...
    ask: {
      ...
      card: "Weisch das no?",
      reply: "Weli Antwort passt?",
      gist: "Was isch gmeint?",
      transform: "Wele Satz seit genau das?",
      clock: "Weli Zahl isch das?",
      meaning: "Was heisst s Wort da?",
    },
    /**
    ...
    lessons: {
      ...
      "yes-no": "Staht s Verb vorne (Händ Sie …? Sind Sie …? Bruuched Sie …?), isch es e Ja-Nei-Frag. Di passend Antwort faht mit Ja oder Nei aa — oder git genau das, wo gfragt isch.",
      "offer": "«Wänd Sie …?» heisst «Möchten Sie …?», «Dörf s no öppis sii?» heisst «Darf es noch etwas sein?» — es Aagebot. Mer nimmt s aa oder seit Nei, mit emene merci.",
      "request": "«Chönd Sie …?» und «Chasch du …?» sind vo de Form här Frage und gmeint als Bitte. D Antwort isch e Zuesag oder e Absag, kei Uskunft.",
      "question-word": "S Fragwort entscheidet: Wie, Wie lang, Wänn, Wo, Was, Wer, Weli. Lose Si zerscht druf — d Antwort mues genau die Lugge fülle.",
      "past": "Züridütsch hät kei Präteritum. «war» heisst «isch gsi», «ging» heisst «isch gange», «sagte» heisst «hät gseit». Wer uf es «war» wartet, verpasst, dass es scho verbii isch.",
      "since": "«sit» isch «seit»: es fragt, wie lang öppis scho eso isch. «für drüü Täg» git Antwort uf e anderi Frag — wie lang s söll duure.",
      ...
      "whose": "Züridütsch seit «wo» für der, die, das im Relativsatz (De Maa, wo dört staht) und «em Herr Meier sis Zimmer» für Herrn Meiers Zimmer. Lose Si, WER gmeint isch.",
  ...
  organisations: {
    ...
    teamsTitle: "Heidi für Teams",
    teamsBody: "Leged Sie e Gruppe für Ihres Team aa und wähled Sie de Schwerpunkt — öppe d Situatione im Pflegeheim. Ihri Lüüt üebed uf ihrne eigene Grät und entscheided sälber, öb s Ihne zeiged, i welne Situatione s sicher sind. Wer e Situation beherrscht, überchunt defür en Nachwiis, wo Sie über sin Link chönd prüefe.",
    teamsCta: "Team aalege",
  ...
  situations: {
    ...
    verified: "Jede Satz isch maschinell uf Zürcher Forme prüeft: Forme us andere Mundarte oder us Dütschland chömed nöd dure.",
    hear: "Das höred Sie",
    say: "Das säged Sie",
    linesLabel: "Sätz",
    ...
    strength: {
      ...
      weakest: "Da lohnt sich s Üebe grad am meischte",
    },
    domains: {
      everyday: {
        title: "Alltag i Züri",
