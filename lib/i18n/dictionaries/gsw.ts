...
export const gsw: Dictionary = {
  ...
  roadmapFeedback: {
    needed: "Bruuch ich",
    notNeeded: "Bruuch ich nöd",
    tally: "{needed} bruuched s, {notNeeded} nöd",
    comments: "Kommentär",
    commentPlaceholder: "Was dänked Sie?",
    send: "Schicke",
    noComments: "No kei Kommentär.",
    suggestTitle: "Fählt öppis?",
    suggestPlaceholder: "Schlönd Sie e Funktion vor",
    suggest: "Vorschlaa",
    similarTitle: "Öpper hät scho öppis Ähnlichs vorgschlage:",
    support: "Ich au",
    supported: "Zellt",
    postAnyway: "Mis isch anders — glich schicke",
    thanks: "Merci — es staht uf de Lischte.",
    failed: "Das hät nöd klappt. Probiered Sie s nomal.",
    refused: "Bitte schriibed Sie en Satz, mit höchschtens eim Link.",
    intro: "Säged Sie bi jedem Punkt, öb Sie en bruuched, und schlönd Sie vor, was fählt — ohni Konto.",
    changelogIntro: "Zu jedere Änderig chönd Sie öppis säge — ohni Konto.",
  },
  sync: {
