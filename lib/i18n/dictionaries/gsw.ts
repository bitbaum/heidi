...
export const gsw: Dictionary = {
  ...
  practice: {
    ...
    explain: {
      ...
      askOtherWays: "Wie cha me «{text}» uf Züritüütsch no säge?",
      askOtherWaysLabel: "Anders gseit",
      askSimilar: "Weli Wörter seit me z Züri ähnlich wie «{word}» — und was isch s Gägeteil?",
      askSimilarLabel: "Ähnlich und Gägeteil",
      askShortText: "Schriib mer en churze Text uf Züritüütsch mit «{word}», mit Übersetzig.",
      askShortTextLabel: "Churze Text dermit",
      askWordByWord: "Erklär mer «{text}» Wort für Wort.",
