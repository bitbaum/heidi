...
export const gsw: Dictionary = {
  ...
  grammar: {
    ...
    topics: {
      ...
      "modal-particles": {
        title: "«gäll», «halt», «eba» — d Haltig im Satz",
        rule: "Die chliine Wörtli änderet kei Tatsach, nume d Haltig dehinter: «gäll» suecht Zuestimmig, «halt» heisst «da chasch nüt mache», «eba» bestätigt gnau de Punkt.",
