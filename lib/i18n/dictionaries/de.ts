...
export const de = {
  ...
  grammar: {
    ...
    topics: {
      ...
      "modal-particles": {
        title: "«gäll», «halt», «eba» — die Haltung im Satz",
        rule: "Diese Wörtchen ändern keine Tatsache, sondern die Haltung dahinter: «gäll» sucht Zustimmung, «halt» heisst «da ist nichts zu machen», «eba» bestätigt genau den Punkt.",
