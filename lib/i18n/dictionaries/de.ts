...
export const de = {
  ...
  nav: {
    ...
    blurbs: {
      home: "Die Startseite",
      chat: "Nachricht einfügen, erklären lassen, antworten",
      situations: "Echte Sätze aus Alltag, Arbeit und Pflege",
      grammar: "Die Regeln, die man hört, aber nicht kennt",
      dialect: "Zürich, Bern, Basel, Wallis und die anderen",
      vocabulary: "Die Wörter, die am Mittagstisch fallen",
      speaking: "Selber sagen, mit Rückmeldung",
      practice: "Kurze Übungen mit Erklärung",
      listen: "Podcasts, Sendungen und Serien in Mundart",
      essays: "Hintergründe und Geschichten",
      paper: "Wie Heidi gebaut ist, im Detail",
      roadmap: "Was als Nächstes kommt",
      changelog: "Was sich zuletzt geändert hat",
      method: "Worauf das Lernen hier beruht",
      technology: "Modelle, Prüfung und Datenschutz",
      contribute: "Mitbauen und mitreden",
      about: "Wer hinter Heidi steht",
      organisations: "Heidi für Teams, Heime und Spitäler",
    },
    closeMenu: "Menü schliessen",
    quickChat: "Mit Heidi chatten",
    quickPractice: "Jetzt üben",
  },
  ...
  model: {
    ...
    test: "Dieses Modell verwenden",
    testing: "Wird geprüft …",
    connected: "Verbunden",
    connectedWith: "Verbunden mit",
    failed: "Das hat nicht geklappt",
    pasteHint: "Schlüssel einfügen — Heidi prüft ihn sofort und zeigt, welche Modelle er kann.",
    strongest: "stärkstes",
    vendorSaid: "Der Anbieter meldet:",
  ...
  pillars: [
    ...
    },
    {
      ...
      body: "Keine Punkte, keine erfundenen Prozentzahlen. Die Zahl, die wir Ihnen zeigen wollen, ist, wie viel Sie von einer unbekannten Zürcher Stimme verstehen — vorher und nachher.",
    },
  ],
  ...
  research: {
    ...
    decisions: [
      ...
      "Gemessen statt vergoldet. Keine Punkte, keine erfundenen Zahlen.",
  ...
  sync: {
    ...
    signInFirst: "Melden Sie sich an, um Ihren Fortschritt auf allen Geräten zu haben.",
    turnOn: "Einschalten",
    turnOff: "Ausschalten",
    on: "Eingeschaltet — dieser Browser gleicht mit Ihren anderen Geräten ab.",
    deleteAll: "Alles Abgeglichene löschen",
    deleted: "Gelöscht. Auf dem Server liegt nichts mehr von Ihrem Fortschritt.",
    failed: "Das hat nicht geklappt. Versuchen Sie es noch einmal.",
  },
  certificate: {
    title: "Nachweis",
    get: "Nachweis ausstellen",
    getting: "Wird geprüft …",
    view: "Nachweis ansehen",
    syncFirst: "Melden Sie sich an und schalten Sie in den Einstellungen «Fortschritt auf allen Geräten» ein. Der Nachweis wird auf dem Server aus Ihrem abgeglichenen Fortschritt ausgestellt, nicht aus diesem Browser.",
    notYet: "Auf dem Server sind erst {held} von {total} Sätzen sicher — der Abgleich holt gleich auf. Versuchen Sie es in einer Minute noch einmal.",
    failed: "Das hat nicht geklappt. Versuchen Sie es noch einmal.",
    holder: "Wer diesen Nachweis hält,",
    statement: "hat in der Situation «{scene}» jeden der {total} Sätze, die Heidi dazu abfragt, wiederholt richtig verstanden.",
    measured: "{held} von {total} Sätzen sicher, {stuck} davon nach einer Pause erneut.",
    issued: "Ausgestellt am {date}",
    idLabel: "Nachweis-Nr.",
    method: "So prüft Heidi",
    scope: "Ein Nachweis über Hörverstehen in einer Situation — kein Sprachdiplom.",
    nameLabel: "Name für den Ausdruck (wird nicht gespeichert)",
    print: "Drucken",
    notFound: "Diesen Nachweis gibt es nicht.",
  },
  team: {
    title: "Team",
    lead: "Wählen Sie, woran Ihr Team arbeitet. Die Mitglieder entscheiden selbst, ob sie Ihnen zeigen, wie weit sie in diesen Situationen sind — nie, welche Sätze oder was sie falsch gemacht haben.",
    focusLabel: "Schwerpunkt",
    none: "Kein Team — eine Lerngruppe",
    overviewEmpty: "Noch niemand im Team zeigt Ihnen den Stand. Jedes Mitglied kann das auf der Gruppenseite einschalten.",
    private: "zeigt den Stand nicht",
    noSync: "teilt, hat aber «Fortschritt auf allen Geräten» nicht eingeschaltet — noch nichts zu sehen",
    ready: "{n} von {total} Situationen sicher",
    certificates: "Nachweise: {n}",
    new: "neu",
    met: "angefangen",
    steady: "meistens",
    sure: "sicher",
    shareTitle: "Ihr Stand im Team",
    shareBody: "Zeigt {name}, wie weit Sie in den Situationen des Teams sind — nie, welche Sätze oder was Sie falsch gemacht haben. Dafür muss in den Einstellungen «Fortschritt auf allen Geräten» eingeschaltet sein.",
    shareOn: "Mit {name} teilen",
    shareOff: "Nicht mehr teilen",
    sharing: "Sie teilen Ihren Stand.",
    failed: "Das hat nicht geklappt. Versuchen Sie es noch einmal.",
  },
  streak: {
    title: "Ihre Serie",
  ...
  practice: {
    ...
    note: "Was Sie gemerkt haben, bleibt in Ihrem Browser — ausser Sie schalten in den Einstellungen «Fortschritt auf allen Geräten» ein. Für die Fragen aus dem Wortschatz brauchen Sie kein Konto.",
    start: "Losgehen",
    restart: "Nochmals",
    ...
    why: [
      ...
      {
        claim: "Keine Punkte, keine Prozentzahl — und eine Serie ohne Vorwurf.",
        detail:
          "Punkte messen, wie viel Heidi Sie konsumiert haben, und sehen dabei aus wie ein Mass fürs Lernen. Die Serie zählt nur Tage, an denen Sie geübt haben, und endet nie mit einem «verloren». Was hier steht, sind Zahlen über das, was Sie getan haben.",
        source: cite("yang-2021"),
      },
    ],
  ...
  organisations: {
    ...
    teamsBody: "Legen Sie eine Gruppe für Ihr Team an und wählen Sie den Schwerpunkt — etwa die Situationen im Pflegeheim. Ihre Leute üben auf ihren eigenen Geräten und entscheiden selbst, ob sie Ihnen zeigen, in welchen Situationen sie sicher sind. Wer eine Situation beherrscht, erhält dafür einen Nachweis, den Sie über seinen Link prüfen können.",
    teamsCta: "Team anlegen",
