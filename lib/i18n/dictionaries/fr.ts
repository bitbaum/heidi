...
export const fr: Dictionary = {
  ...
  practice: {
    ...
    explain: {
      ...
      askOtherWays: "Comment dire autrement «{text}» en suisse allemand de Zurich ?",
      askOtherWaysLabel: "Autrement dit",
      askSimilar: "Quels mots zurichois ont un sens proche de «{word}» — et quel est le contraire ?",
      askSimilarLabel: "Proche et contraire",
      askShortText: "Écris-moi un court texte en suisse allemand de Zurich avec «{word}», avec traduction.",
      askShortTextLabel: "Court texte avec",
      askWordByWord: "Explique-moi «{text}» mot à mot.",
      askWordByWordLabel: "Mot à mot",
