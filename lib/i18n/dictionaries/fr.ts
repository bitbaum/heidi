...
export const fr: Dictionary = {
  ...
  grammar: {
    ...
    topics: {
      ...
      "modal-particles": {
        title: "«gäll», «halt», «eba» — la position de celui qui parle",
        rule: "Ces petits mots ne changent aucun fait, seulement la position derrière : «gäll» cherche votre accord, «halt» signifie qu\u2019on n\u2019y peut rien, «eba» confirme exactement le point.",
