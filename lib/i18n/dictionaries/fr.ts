...
export const fr: Dictionary = {
  ...
  roadmapFeedback: {
    needed: "J’en ai besoin",
    notNeeded: "Pas pour moi",
    tally: "{needed} en ont besoin, {notNeeded} non",
    comments: "Commentaires",
    commentPlaceholder: "Qu’en pensez-vous ?",
    send: "Envoyer",
    noComments: "Pas encore de commentaire.",
    suggestTitle: "Il manque quelque chose ?",
    suggestPlaceholder: "Proposez une fonctionnalité",
    suggest: "Proposer",
    similarTitle: "Quelqu’un a déjà proposé quelque chose de semblable :",
    support: "Moi aussi",
    supported: "Compté",
    postAnyway: "La mienne est différente — envoyer quand même",
    thanks: "Merci — c’est sur la liste.",
    failed: "Cela n’a pas marché. Veuillez réessayer.",
    refused: "Écrivez une phrase, avec au plus un lien.",
    intro: "Dites-nous si vous avez besoin de chaque point et proposez ce qui manque — sans compte.",
    changelogIntro: "Vous pouvez commenter chaque changement — sans compte.",
  },
  sync: {
