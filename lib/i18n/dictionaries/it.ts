...
export const it: Dictionary = {
  ...
  grammar: {
    ...
    topics: {
      ...
      "modal-particles": {
        title: "«gäll», «halt», «eba» — la posizione di chi parla",
        rule: "Queste paroline non cambiano alcun fatto, solo la posizione dietro: «gäll» cerca il suo consenso, «halt» significa che non c\u2019è niente da fare, «eba» conferma esattamente il punto.",
