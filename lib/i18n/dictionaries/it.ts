...
export const it: Dictionary = {
  ...
  nav: {
    ...
    blurbs: {
      ...
      chat: "Incollare un messaggio, farselo spiegare, rispondere",
      situations: "Frasi vere dalla vita quotidiana, dal lavoro e dalla cura",
      grammar: "Le regole che si sentono ma non si conoscono",
      dialect: "Zurigo, Berna, Basilea, Vallese e gli altri",
      vocabulary: "Le parole che si sentono a pranzo",
      speaking: "Dirlo da sé, con un riscontro",
      practice: "Esercizi brevi, spiegati",
      listen: "Podcast, programmi e serie in dialetto",
      essays: "Retroscena e storie",
      paper: "Come è costruita Heidi, nel dettaglio",
      roadmap: "Cosa arriva dopo",
      changelog: "Cosa è cambiato di recente",
      method: "Su cosa si basa l’apprendimento qui",
      technology: "Modelli, verifica e privacy",
      contribute: "Costruire e dire la propria",
      about: "Chi c’è dietro Heidi",
      organisations: "Heidi per team, case di cura e ospedali",
    },
    closeMenu: "Chiudere il menu",
    quickChat: "Chattare con Heidi",
    quickPractice: "Esercitarsi ora",
  },
  ...
  home: {
    ...
    orgTitle: "Per team e organizzazioni",
  ...
  practice: {
    ...
    ask: {
      ...
      reply: "Quale risposta va bene?",
      gist: "Che cosa si intende?",
      transform: "Quale frase dice esattamente questo?",
      clock: "Che numero è?",
      meaning: "Che cosa vuol dire la parola qui?",
    },
    /**
     ...
     */
    lessons: {
      "false-friend": "«{word}» sembra una parola tedesca che conosce — ma non vuol dire «{trap}», vuol dire «{means}». Sono proprio le parole che si fraintendono senza accorgersene.",
      "word": "«{word}» vuol dire «{means}». Lo ricordi con la sua frase, non da solo: una parola riconosciuta nel contesto si riconosce anche in una conversazione.",
      "clock-half": "«halbi drüü» è «halb drei»: la mezz'ora PRIMA dell'ora nominata, quindi 2:30 — non le tre e mezza. L'ora prende spesso una -i: vieri, achti, zwölfi.",
      "clock-quarter": "Nell'orario «ab» vuol dire «nach» (dopo): Viertel ab drüü sono le 3:15. «vor» resta «vor»: Viertel vor drüü sono le 2:45.",
      "price": "Prima i franchi, poi i centesimi, senza «und» in mezzo: drüü Franke zwänzg fa 3.20. Le decine finiscono in -zg: zwänzg, drissg, vierzg, füfzg.",
      "either-or": "Una domanda con «oder» vuole indietro una delle due possibilità — non un sì o un no.",
      "yes-no": "Se il verbo viene per primo (Händ Sie …? Sind Sie …? Bruuched Sie …?), è una domanda sì/no. La risposta giusta comincia con Ja o Nei — oppure dà esattamente ciò che è chiesto.",
      "offer": "«Wänd Sie …?» è «Möchten Sie …?», «Dörf s no öppis sii?» è «Darf es noch etwas sein?» — un'offerta. Si accetta o si rifiuta, con un merci.",
      "request": "«Chönd Sie …?» e «Chasch du …?» sono domande nella forma e richieste nel senso. Si risponde accettando o rifiutando, non con un'informazione.",
      "question-word": "Decide la parola interrogativa: Wie (come), Wie lang (quanto tempo), Wänn (quando), Wo (dove), Was (che cosa), Wer (chi), Weli (quale). La ascolti per prima — la risposta deve riempire esattamente quel vuoto.",
      "past": "Lo zurighese non ha il preterito. «war» si dice «isch gsi», «ging» «isch gange», «sagte» «hät gseit». Chi aspetta un «war» non si accorge che è già passato.",
      "since": "«sit» è «seit» (da): chiede da quanto tempo una cosa è così. «für drüü Täg» risponde a un'altra domanda — quanto deve durare.",
      "indirect-no": "A Zurigo si rifiuta raramente in modo diretto. «Mer luegt dänn», «Das müesst mer no aaluege» o «Villicht es anders Mal» sono di solito già la risposta — incartata con garbo.",
      "mag": "In zurighese «möge» vuol dire spesso avere la forza o sentirsela, non solo piacere. «Ich mag nüme» significa: non ce la faccio più.",
      "es-haet": "«Es hät» vuol dire spesso «es gibt» (c'è, ci sono): Es hät Lüüs — ci sono pidocchi. Chi sente «es hat» cerca invano chi abbia qualcosa.",
      "person": "Ascolti la persona: mir = wir, Chömed er = kommt ihr, si = sie, mer = man o wir, Ihne = Ihnen. Al plurale il verbo ha una sola forma per tutte e tre le persone: la persona sta solo nel pronome. L'imperativo di cortesia finisce in -ed con Sie (Blibed Sie), quello col tu no (Blib).",
      "verb-frame": "La cornice del verbo porta il senso: «isch am warte» è adesso, «go» è andare là, «cho» venire qui, «hät gwartet» è finito.",
      "small-word": "Una sola parolina decide tutta la frase — è indicata sopra. Sono proprio le parole che si perdono, perché in tedesco standard suonano diverse o non esistono.",
      "whose": "Lo zurighese dice «wo» per der, die, das nella relativa (De Maa, wo dört staht) e «em Herr Meier sis Zimmer» per «Herrn Meiers Zimmer». Ascolti CHI è inteso.",
      "thanks-sorry": "La risposta reagisce a ciò che è successo: a un favore segue un grazie, a un rimprovero una scusa, ai fiori un vaso. Il participio dice che cosa è successo: aagnoh, gleert, mitbrocht.",
      "comfort": "Chi ha paura, ha dolore o non ce la fa ha bisogno prima di tutto di una risposta proprio a questo — non di un'informazione su altro.",
    },
