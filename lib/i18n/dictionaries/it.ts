...
export const it: Dictionary = {
  ...
  ask: {
    understand: "Capire",
    produce: "Dirlo",
    understandHint: "Incollate quello che avete ricevuto",
    produceHint: "Scrivete quello che intendete",
    understandPlaceholder: "Im Kauz scho, hät mer nöd so gfalle. Du au?",
    producePlaceholder: "Di' loro che arrivo dieci minuti più tardi — gentilmente.",
    submit: "Chiedere",
    working: "Heidi sta leggendo …",
    shortcut: "⌘ + Invio",
    tryOne: "Oppure provate questo",
    meaningTitle: "Vuol dire",
    sendTitle: "Potete mandare questo",
    glossTitle: "Parole da tenere",
    repliesTitle: "Potreste rispondere",
    alternativesTitle: "Altre formulazioni",
    copy: "Copia",
    copied: "Copiato",
    flagged: "Non è zurighese:",
    checkedNote: "Ogni riga qui sopra è stata verificata secondo le forme zurighesi",
    ...
    empty: "Date a Heidi qualcosa su cui lavorare.",
    tooLong: "È più lungo di 2000 caratteri.",
    ...
    examplesProduce: [
      ...
      "Chiedi alla vicina se posso lasciare un pacco da lei.",
      "Rifiuta un invito a cena senza sembrare freddo.",
    ],
  },
  ...
  check: {
    ...
    intro:
      "Incollate un testo che dovrebbe essere zurighese. Questa verifica è un elenco di regole fisse — non un modello linguistico — e segnala le forme che vengono da un'altra regione svizzero-tedesca o che in Svizzera non esistono affatto.",
