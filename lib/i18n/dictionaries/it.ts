...
export const it: Dictionary = {
  ...
  practice: {
    ...
    explain: {
      ...
      askOtherWays: "Come si può dire altrimenti «{text}» in zurighese?",
      askOtherWaysLabel: "Detto altrimenti",
      askSimilar: "Quali parole zurighesi hanno un senso simile a «{word}» — e qual è il contrario?",
      askSimilarLabel: "Simile e contrario",
      askShortText: "Scrivimi un breve testo in zurighese con «{word}», con traduzione.",
      askShortTextLabel: "Breve testo con",
      askWordByWord: "Spiegami «{text}» parola per parola.",
      askWordByWordLabel: "Parola per parola",
  ...
  speaking: {
    ...
    hesitationTitle: "Dove ha esitato",
