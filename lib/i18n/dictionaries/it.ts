...
export const it: Dictionary = {
  ...
  roadmapFeedback: {
    needed: "Mi serve",
    notNeeded: "Non mi serve",
    tally: "{needed} dicono che serve, {notNeeded} di no",
    comments: "Commenti",
    commentPlaceholder: "Che cosa ne pensa?",
    send: "Invia",
    noComments: "Ancora nessun commento.",
    suggestTitle: "Manca qualcosa?",
    suggestPlaceholder: "Proponga una funzione",
    suggest: "Proporre",
    similarTitle: "Qualcuno ha già proposto qualcosa di simile:",
    support: "Anch’io",
    supported: "Contato",
    postAnyway: "La mia è diversa — invia comunque",
    thanks: "Grazie — è nell’elenco.",
    failed: "Non ha funzionato. Riprovi.",
    refused: "Scriva una frase, con al massimo un link.",
    intro: "Ci dica se le serve ogni punto e proponga ciò che manca — senza account.",
    changelogIntro: "Può commentare ogni modifica — senza account.",
  },
  streak: {
    title: "La sua serie",
