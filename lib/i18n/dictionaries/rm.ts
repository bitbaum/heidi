...
export const rm: Dictionary = {
  ...
  nav: {
    ...
    blurbs: {
      home: "La pagina da partenza",
      chat: "Tschentar en in messadi, laschar explitgar, respunder",
      situations: "Frasas vairas dal mintgadi, da la lavur e da la tgira",
      grammar: "Las reglas ch’ins auda, ma na enconuscha betg",
      dialect: "Turitg, Berna, Basilea, Vallais e las autras",
      vocabulary: "Ils pleds ch’ins auda a maisa",
      speaking: "Dir sez, cun resuns",
      practice: "Curts exercizis cun explicaziun",
      listen: "Podcasts, emissiuns e serias en dialect",
      essays: "Fundaments ed istorgias",
      paper: "Co che Heidi è construida, en detagl",
      roadmap: "Tge che vegn sco proxim",
      changelog: "Tge ch’è sa midà ultimamain",
      method: "Sin tge che l’emprender sa basa qua",
      technology: "Models, controlla e protecziun da datas",
      contribute: "Construir e discurrer cun",
      about: "Tgi che stat davos Heidi",
      organisations: "Heidi per teams, chasas da tgira ed ospitals",
    },
    closeMenu: "Serrar il menu",
    quickChat: "Chattar cun Heidi",
    quickPractice: "Exercitar ussa",
  },
  ...
  model: {
    ...
    test: "Duvrar quest model",
    testing: "Vegn controllà …",
    connected: "Collià",
    connectedWith: "Collià cun",
    failed: "Quai n'ha betg funcziunà",
    pasteHint: "Tschentai en ina clav — Heidi la controllescha immediat e mussa tge models ch’ella po duvrar.",
    strongest: "il pli ferm",
    vendorSaid: "Il purschider annunzia:",
  ...
  pillars: [
    ...
    },
    {
      ...
      body: "Nagins puncts, naginas pertschientualas inventadas. Il numer che nus vulain Vus mussar è quant ch'e Vus chapis d'ina vusch turitgaisa nunenconuschenta — avant e suenter.",
    },
  ],
  ...
  research: {
    ...
    decisions: [
      ...
      "Mesirà enstagl da gamificà. Nagins puncts, naginas cifras inventadas.",
  ...
  practice: {
    ...
    ask: {
      ...
      reply: "Tge resposta va bain?",
      gist: "Tge è manegià?",
      transform: "Tge frasa di exactamain quai?",
      clock: "Tge numer è quai?",
      meaning: "Tge munta il pled qua?",
    },
    /**
     ...
     */
    lessons: {
      "false-friend": "«{word}» para in pled tudestg che Vus enconuschais — ma el na munta betg «{trap}», el munta «{means}». Quai èn ils pleds ch'ins chapescha fallà senza s'accorscher.",
      "word": "«{word}» munta «{means}». Tegnai endament el cun sia frasa, betg sulet: in pled renconuschì en il context renconuscha ins er en in discurs.",
      "clock-half": "«halbi drüü» è «halb drei»: la mesa ura AVANT l'ura numnada, pia 2:30 — betg las trais e mesa. L'ura survegn savens in -i: vieri, achti, zwölfi.",
      "clock-quarter": "Tar l'ura munta «ab» «nach» (suenter): Viertel ab drüü è 3:15. «vor» resta «vor»: Viertel vor drüü è 2:45.",
      "price": "L'emprim ils francs, lura ils raps, senza «und» tranteren: drüü Franke zwänzg è 3.20. Las decinas finan cun -zg: zwänzg, drissg, vierzg, füfzg.",
      "either-or": "Ina dumonda cun «oder» vul enavos ina da las duas pussaivladads — betg gea u na.",
      "yes-no": "Sch'il verb stat davant (Händ Sie …? Sind Sie …? Bruuched Sie …?), èsi ina dumonda da gea u na. La resposta adattada cumenza cun Ja u Nei — u dat exactamain quai ch'è vegnì dumandà.",
      "offer": "«Wänd Sie …?» è «Möchten Sie …?», «Dörf s no öppis sii?» è «Darf es noch etwas sein?» — ina purschida. Ins accepta u refusa, cun in merci.",
      "request": "«Chönd Sie …?» e «Chasch du …?» èn dumondas tenor la furma e rugaziuns tenor il senn. Ins respunda cun ina acceptaziun u in refus, betg cun ina infurmaziun.",
      "question-word": "Il pled da dumonda decida: Wie (co), Wie lang (quant ditg), Wänn (cura), Wo (nua), Was (tge), Wer (tgi), Weli (tge). Tadlai l'emprim sin quel — la resposta sto emplenir exactamain quella largia.",
      "past": "Il tudestg da Turitg n'ha nagin preterit. «war» è «isch gsi», «ging» è «isch gange», «sagte» è «hät gseit». Tgi che spetga sin in «war» na s'accorscha betg ch'i è gia passà.",
      "since": "«sit» è «seit» (dapi): i vegn dumandà dapi cura ch'insatge è uschia. «für drüü Täg» respunda ad in'autra dumonda — quant ditg ch'i duai durar.",
      "indirect-no": "A Turitg refusa ins darar directamain. «Mer luegt dänn», «Das müesst mer no aaluege» u «Villicht es anders Mal» èn per ordinari gia la resposta — enzugliada cun curtaschia.",
      "mag": "En il tudestg da Turitg munta «möge» savens avair la forza u sa sentir abel, betg mo avair gugent. «Ich mag nüme» munta: jau na poss betg pli.",
      "es-haet": "«Es hät» munta savens «es gibt» (i dat): Es hät Lüüs — i dat «Läuse». Tgi che auda «es hat» tschertga per nagut quel che ha insatge.",
      "person": "Tadlai sin la persuna: mir = wir, Chömed er = kommt ihr, si = sie, mer = man u wir, Ihne = Ihnen. En il plural ha il verb ina suletta furma per tuttas trais persunas: la persuna è mo en il pronom. L'imperativ da curtaschia finescha cun -ed e Sie (Blibed Sie), la furma cun du betg (Blib).",
      "verb-frame": "La furma enturn il verb porta il senn: «isch am warte» è ussa, «go» è ir là, «cho» vegnir nà, «hät gwartet» è passà.",
      "small-word": "In sulet pled pitschen decida l'entira frasa — el stat survart. Quai èn gist ils pleds ch'ins na auda betg, perquai ch'els tunan auter en tudestg standard u n'existan betg.",
      "whose": "Il tudestg da Turitg di «wo» per der, die, das en la frasa relativa (De Maa, wo dört staht) ed «em Herr Meier sis Zimmer» per «Herrn Meiers Zimmer». Tadlai TGI ch'è manegià.",
      "thanks-sorry": "La resposta reagescha sin quai ch'è capità: sin in plaschair suonda in grazia, sin in reproschi ina stgisa, sin flurs in vas. Il participi di tge ch'è capità: aagnoh, gleert, mitbrocht.",
      "comfort": "Tgi che ha tema, ha dolurs u na po betg pli dovra l'emprim ina resposta gist a quai — betg ina infurmaziun davart insatge auter.",
    },
    ...
    why: [
      ...
      {
        claim: "Nagins puncts, nagina percentuala — ed ina seria senza reproschas.",
        detail:
          "Puncts mesiran quant Heidi che Vus avais consumà e paran intant da mesirar l'emprender. La seria dumbra mo ils dis che Vus avais exercità e na finescha mai cun «pers». Qua stattan cifras davart quai che Vus avais fatg.",
        source: ["yang-2021"],
      },
    ],
