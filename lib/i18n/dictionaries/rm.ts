...
export const rm: Dictionary = {
  ...
  practice: {
    ...
    explain: {
      ...
      askOtherWays: "Co pon ins dir autramain «{text}» en tudestg da Turitg?",
      askOtherWaysLabel: "Ditg autramain",
      askSimilar: "Tge pleds da Turitg han in senn sumegliant sco «{word}» — e tge è il cuntrari?",
      askSimilarLabel: "Sumegliant e cuntrari",
      askShortText: "Scriva a mai in curt text en tudestg da Turitg cun «{word}», cun translaziun.",
      askShortTextLabel: "Curt text cun quai",
      askWordByWord: "Explitgescha a mai «{text}» pled per pled.",
      askWordByWordLabel: "Pled per pled",
