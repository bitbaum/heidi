...
export const rm: Dictionary = {
  ...
  grammar: {
    ...
    topics: {
      ...
      "modal-particles": {
        title: "«gäll», «halt», «eba» — la posiziun da quel che discurra",
        rule: "Quests pleds pitschens na midan nagin fatg, mabain la posiziun davos: «gäll» tschertga Voss consentiment, «halt» vul dir ch\u2019i na va betg autra, «eba» conferma gist quel punct.",
