...
export const en: Dictionary = {
  ...
  roadmapFeedback: {
    needed: "I need this",
    notNeeded: "Not for me",
    tally: "{needed} need this, {notNeeded} don’t",
    comments: "Comments",
    ...
    suggest: "Suggest",
    similarTitle: "Someone already suggested something similar:",
    support: "Me too",
    supported: "Counted",
    postAnyway: "Mine is different — send it anyway",
    thanks: "Thank you — it’s on the list.",
    failed: "That didn’t work. Please try again.",
    refused: "Please write a sentence, with at most one link.",
    intro: "Tell us whether you need each item, and suggest what is missing — no account needed.",
    changelogIntro: "You can comment on every change — no account needed.",
  },
  sync: {
