...
export const en: Dictionary = {
  ...
  practice: {
    ...
    explain: {
      ...
      askOtherWays: "How else can «{text}» be said in Zurich German?",
      askOtherWaysLabel: "Said differently",
      askSimilar: "Which words mean something similar to «{word}» in Zurich — and what is the opposite?",
      askSimilarLabel: "Similar and opposite",
      askShortText: "Write me a short text in Zurich German using «{word}», with a translation.",
      askShortTextLabel: "Short text with it",
      askWordByWord: "Explain «{text}» to me word by word.",
      askWordByWordLabel: "Word by word",
