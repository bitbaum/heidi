...
export const en: Dictionary = {
  ...
  grammar: {
    ...
    topics: {
      ...
      "modal-particles": {
        title: "«gäll», «halt», «eba» — where the speaker stands",
        rule: "These small words change no fact, only the position behind it: «gäll» asks you to agree, «halt» means nothing can be done, «eba» says that is exactly the point.",
