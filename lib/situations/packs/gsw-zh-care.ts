  ...
  situations: [
    {
      ...
      phrases: [
        ...
        { target: "D Frau Keller hät i de Nacht zweimal glüütet.", bridge: "Frau Keller hat in der Nacht zweimal geläutet.", direction: "hear", grammar: "no-preterite", source: "idiotikon" },
        { target: "Er isch hüt ächli verwirrt.", bridge: "Er ist heute etwas verwirrt.", direction: "hear", source: "idiotikon" },
        { target: "D Tochter chunt am Namittag verbii.", bridge: "Die Tochter kommt am Nachmittag vorbei.", direction: "hear", grammar: "articles", source: "idiotikon" },
        { target: "Si hät gseit, si well hüt nöd dusche.", bridge: "Sie hat gesagt, sie wolle heute nicht duschen.", direction: "hear", grammar: "no-preterite", source: "idiotikon" },
        { target: "Mir sind hüt nur zu dritt.", bridge: "Wir sind heute nur zu dritt.", direction: "hear", grammar: "unified-plural", source: "idiotikon" },
        { target: "Chasch du s Zimmer vieri übernäh?", bridge: "Kannst du Zimmer vier übernehmen?", direction: "hear", source: "idiotikon" },
        { target: "D Familie isch informiert.", bridge: "Die Familie ist informiert.", direction: "hear", grammar: "articles", source: "idiotikon" },
        { target: "Si isch geschter fascht umgheit.", bridge: "Sie wäre gestern fast gestürzt.", direction: "hear", grammar: "no-preterite", source: "idiotikon" },
        { target: "Isch no öppis Bsunders?", bridge: "Gibt es noch etwas Besonderes?", direction: "say", source: "idiotikon" },
        { target: "Guet, das mach ich.", bridge: "Gut, das mache ich.", direction: "say", source: "idiotikon" },
      ],
    },

    {
      ...
      phrases: [
        ...
        { target: "Händ Sie guet gschlaafe?", bridge: "Haben Sie gut geschlafen?", direction: "say", grammar: "no-preterite", source: "idiotikon" },
        { target: "Nei, gar nöd.", bridge: "Nein, überhaupt nicht.", direction: "hear", source: "idiotikon" },
        { target: "Ich mach s Fänschter ächli uf.", bridge: "Ich mache das Fenster ein bisschen auf.", direction: "say", grammar: "articles", source: "idiotikon" },
        { target: "Mir isch chalt.", bridge: "Mir ist kalt.", direction: "hear", source: "idiotikon" },
        { target: "Wele Pulli wänd Sie hüt aalege?", bridge: "Welchen Pullover möchten Sie heute anziehen?", direction: "say", grammar: "question-words", source: "idiotikon" },
        { target: "Dä blau, bitte.", bridge: "Den blauen, bitte.", direction: "hear", source: "idiotikon" },
        { target: "Ich cha das sälber.", bridge: "Ich kann das selber.", direction: "hear", source: "idiotikon" },
        { target: "Guet, mached Sie nume.", bridge: "Gut, machen Sie nur.", direction: "say", source: "idiotikon" },
        { target: "Wo isch mini Brülle?", bridge: "Wo ist meine Brille?", direction: "hear", source: "idiotikon" },
        { target: "Si liit uf em Nachttischli.", bridge: "Sie liegt auf dem Nachttisch.", direction: "say", grammar: "diminutive-li", source: "idiotikon" },
      ],
    },

    {
      ...
      phrases: [
        ...
        { target: "Es sticht da vorne.", bridge: "Es sticht hier vorne.", direction: "hear", source: "idiotikon" },
        { target: "Chönd Sie mer zeige, wo?", bridge: "Können Sie mir zeigen, wo?", direction: "say", source: "idiotikon" },
        { target: "Da, am Arm.", bridge: "Hier, am Arm.", direction: "hear", source: "idiotikon" },
        { target: "Isch es schlimmer worde?", bridge: "Ist es schlimmer geworden?", direction: "say", grammar: "no-preterite", source: "idiotikon" },
        { target: "Es isch wie geschter.", bridge: "Es ist wie gestern.", direction: "hear", source: "idiotikon" },
        { target: "Ich ha d Nacht nöd chöne schlafe.", bridge: "Ich konnte in der Nacht nicht schlafen.", direction: "hear", grammar: "no-preterite", source: "idiotikon" },
        { target: "Ligged Sie eso besser?", bridge: "Liegen Sie so besser?", direction: "say", source: "idiotikon" },
        { target: "Nei, lönd Sie mich.", bridge: "Nein, lassen Sie mich.", direction: "hear", grammar: "imperative", source: "idiotikon" },
        { target: "Ich hol grad öpper.", bridge: "Ich hole gleich jemanden.", direction: "say", source: "idiotikon" },
        { target: "Es gaht scho, merci.", bridge: "Es geht schon, danke.", direction: "hear", source: "idiotikon" },
      ],
    },

    {
      ...
      phrases: [
        ...
        { target: "Hüt git s Poulet mit Rüebli.", bridge: "Heute gibt es Poulet mit Karotten.", direction: "say", source: "idiotikon" },
        ...
        { target: "Am Zvieri git s es Güetzi.", bridge: "Zum Zvieri gibt es ein Guetzli.", direction: "say", grammar: "diminutive-li", source: "idiotikon" },
        { target: "Chömed Sie cho ässe.", bridge: "Kommen Sie essen.", direction: "say", grammar: "go-cho-infinitive", source: "idiotikon" },
        { target: "Wänd Sie Kafi oder Tee?", bridge: "Möchten Sie Kaffee oder Tee?", direction: "say", source: "idiotikon" },
        { target: "Es Kafi mit Milch, bitte.", bridge: "Einen Kaffee mit Milch, bitte.", direction: "hear", grammar: "indefinite-article", source: "idiotikon" },
        { target: "Das isch mer z heiss.", bridge: "Das ist mir zu heiss.", direction: "hear", source: "idiotikon" },
        { target: "Ich ha kei Hunger.", bridge: "Ich habe keinen Hunger.", direction: "hear", source: "idiotikon" },
        { target: "Nur es paar Löffeli?", bridge: "Nur ein paar Löffelchen?", direction: "say", grammar: "diminutive-li", source: "idiotikon" },
        { target: "Gänd Sie mer no ächli Brot?", bridge: "Geben Sie mir noch etwas Brot?", direction: "hear", source: "idiotikon" },
        { target: "Das han ich früener au gchochet.", bridge: "Das habe ich früher auch gekocht.", direction: "hear", grammar: "no-preterite", source: "idiotikon" },
        { target: "Söll ich Ihne s Fleisch schniide?", bridge: "Soll ich Ihnen das Fleisch schneiden?", direction: "say", grammar: "articles", source: "idiotikon" },
        { target: "Es isch scho guet, ich bi satt.", bridge: "Es ist schon gut, ich bin satt.", direction: "hear", source: "idiotikon" },
        { target: "Morn git s Älplermagerone.", bridge: "Morgen gibt es Älplermagronen.", direction: "say", source: "idiotikon" },
      ],
    },

    {
      ...
      phrases: [
        ...
        { target: "Mini Chind warted uf mich.", bridge: "Meine Kinder warten auf mich.", direction: "hear", grammar: "unified-plural", source: "idiotikon" },
        { target: "Verzelled Sie mer vo Ihrne Chind.", bridge: "Erzählen Sie mir von Ihren Kindern.", direction: "say", grammar: "imperative", source: "idiotikon" },
        { target: "Ich mues doch go choche.", bridge: "Ich muss doch kochen gehen.", direction: "hear", grammar: "go-cho-infinitive", source: "idiotikon" },
        { target: "S Ässe isch scho parat.", bridge: "Das Essen ist schon bereit.", direction: "say", grammar: "articles", source: "idiotikon" },
        { target: "Wer bisch du?", bridge: "Wer bist du?", direction: "hear", source: "idiotikon" },
        { target: "Ich bi vo de Pflege, ich hilf Ihne.", bridge: "Ich bin von der Pflege, ich helfe Ihnen.", direction: "say", source: "idiotikon" },
        { target: "Ich han Angscht.", bridge: "Ich habe Angst.", direction: "hear", source: "idiotikon" },
        { target: "Sie sind nöd elei.", bridge: "Sie sind nicht allein.", direction: "say", source: "idiotikon" },
        { target: "Wänn chunt min Maa?", bridge: "Wann kommt mein Mann?", direction: "hear", grammar: "question-words", source: "idiotikon" },
        { target: "Mir trinked zerscht en Tee zäme.", bridge: "Wir trinken zuerst einen Tee zusammen.", direction: "say", grammar: "unified-plural", source: "idiotikon" },
      ],
    },

    {
      ...
      phrases: [
        ...
        { target: "Isch si i ihrem Zimmer?", bridge: "Ist sie in ihrem Zimmer?", direction: "hear", source: "idiotikon" },
        { target: "Si isch grad im Ufenthaltsruum.", bridge: "Sie ist gerade im Aufenthaltsraum.", direction: "say", source: "idiotikon" },
        { target: "Hät si hüt öppis gesse?", bridge: "Hat sie heute etwas gegessen?", direction: "hear", grammar: "no-preterite", source: "idiotikon" },
        { target: "Mir händ ere Blueme mitbrocht.", bridge: "Wir haben ihr Blumen mitgebracht.", direction: "hear", grammar: "unified-plural", source: "idiotikon" },
        { target: "Ich hol grad e Vase.", bridge: "Ich hole gleich eine Vase.", direction: "say", grammar: "indefinite-article", source: "idiotikon" },
        { target: "Dörf ich mit ere go spaziere?", bridge: "Darf ich mit ihr spazieren gehen?", direction: "hear", grammar: "go-cho-infinitive", source: "idiotikon" },
        { target: "Sie müend sich nur am Empfang abmälde.", bridge: "Sie müssen sich nur am Empfang abmelden.", direction: "say", source: "idiotikon" },
        { target: "Wer isch hüt für si zueständig?", bridge: "Wer ist heute für sie zuständig?", direction: "hear", grammar: "question-words", source: "idiotikon" },
        { target: "Mini Kollegin chunt grad.", bridge: "Meine Kollegin kommt gleich.", direction: "say", source: "idiotikon" },
        { target: "Mir chömed am nöchschte Sunntig wider.", bridge: "Wir kommen nächsten Sonntag wieder.", direction: "hear", grammar: "unified-plural", source: "idiotikon" },
      ],
    },
  ],
};
